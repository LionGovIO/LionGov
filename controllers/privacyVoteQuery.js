module.exports = class privacyVoteQuery {
  ...
  async privacyVoteQuery (req, res) {
    ...
    if (req.query) {
      ...
      if (voteClass) {
        _privacyVoteQuery(queryInput, function(err, output) {
          console.log('output!');
          console.log(output);
