...
module.exports = class submitProposal extends ControllerClass {
  ...
  _submitProposal = (data, callback) => {
    ...
    var proposalType = "multifixed"; // only one proposal type right now
    ...
    for (const i in data.options) {
      awsOptions.push({S: data.options[i]});
    }
    ...
    var params = {
      ...
      Item: {
        ...
        "Options": { // TODO: description might be deprecated in future, might want to be a more flexible body input
          L: awsOptions
        },
        "EndTimestamp": {
