...
function privacyProposalQuery(data, callback) {
...
app.get('/privacyproposalquery', function (req, res) {
    ...
    privacyProposalQuery({}, function (err, output) {
        console.log('output!');
        console.log(output);
...
async function getVoteStats(data, callback) {
    ...
    var allData = null;
    try {
        allData = await getAllData(params);
...
app.get('/getvotestats', async function (req, res) {
    // Retrieve the tag from our URL path
    ...
    if (req.query) {
        ...
        if (voteClass) {
            try {
                getVoteStats(queryInput, function (err, output) {
                    console.log('output!');
                    console.log(output);
...
function submitProposal(data, callback) {
...
// POST method route
app.post('/submitproposal', function (req, res) {
    ...
    submitProposal(postData, function (err, result) {
