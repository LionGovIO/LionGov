                        ...
                        xhr.onreadystatechange = function () {
                            if (xhr.readyState == XMLHttpRequest.DONE) {
                                ...
                                if (xhr.status == 200) {
                                    ...
                                    alert(
                                        "Proposal submission failed, please try again"
                                    );
                                }
                            }
                        };
    ...
    return (
        <div className="container">
            ...
            <div>
                ...
                <div>
                    Note: This creates a proposal with "Yes" or "No" as the
                    options. More proposal types will be supported in the
                    future.
                </div>
            </div>
            ...
            <div>
                ...
                <div>
                    Note: This list may be truncated, need to support viewing of
                    all proposal. Also, ideally should make the proposal ID more
                    human friendly.
                </div>
            ...
            <div className="lead">
                <div id="single_proposal_description">
                    ...
                    back. You take the blue pill—the story ends, you wake up in
                    your bed and believe whatever you want to believe. You take
                    the red pill—you stay in Wonderland, and I show you how deep
                    the rabbit hole goes. Remember: all I'm offering is the
                    truth. Nothing more.
                    <div>
